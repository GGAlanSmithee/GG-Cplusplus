...
//
//    /// @todo refactor this to GGResource Core
...
//    {
//        auto completeName = GGResource::GetShaderSourcePath() + name;
//
...
//        if (!stream.is_open())
//        {
//            GGLoggingManager::LogError("Could not open file with path ", GGResource::GetShaderSourcePath() + name);
//            return "";
//        }
//
//        std::string line;
